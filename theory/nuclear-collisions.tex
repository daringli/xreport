...
\begin{equation}
\rho_{J'}(E^*) \equiv \omega(E^*)_{M=J', J=J'} = \omega(E^*)_{M=J'}  -\omega(E^*)_{M=J'+1},
\end{equation}
...
\begin{equation}
\rho_J(E^*) \approx \frac{\omega(E^*)}{\sqrt{2\langle M^2\rangle}} \frac{2J+1}{2} \exp{\left(-\frac{M^2}{2\langle (J+1/2)^2\rangle}\right)}.\label{eq:rhoj}
\end{equation}
