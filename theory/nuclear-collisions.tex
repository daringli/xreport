...
However, \rtb{} experiments are not necessarily about heavy (and non-exotic) nuclei. For lighter nuclei, the Fermi momentum may be considerable lower\cite{bartke2009introduction}, and for exotic nuclei, such as halo nuclei, the individual nucleons will not have the same momentum distribution.
...
\begin{equation}
\rho(E^*,J) \approx - \frac{d}{dM} \left( \omega(E^*,M)\right)|_{M=J+1/2},\label{eq:odm}
\end{equation}
