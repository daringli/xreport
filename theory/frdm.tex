...
Since the rest of the code does not take deformations into account, this is not really an additional constraint.%: the code cannot be expected to work for nuclei that are not close to being spherical. 
